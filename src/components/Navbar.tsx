    ...
    <nav className="flex w-full h-32 p-5 overflow-visible bg-gray-100">
      <div className="min-w-48 max-w-min">
        <Link className="flex items-center justify-center h-full" to="/" >
          <img className="w-full" src={logo} alt="KigumiGroup" />
        </Link>
      </div>
      ...
      <div className="hidden md:flex items-center justify-between gap-10">
        ...
        <Link id="about" to="/about" className="p-5 rounded-full hover:bg-green-200 active:bg-green-400">
          <p className="text-center">
            {t("About")}
          </p>
        </Link>
        <Link id="signin" to="/signin" className="p-5 rounded-full hover:bg-green-200 active:bg-green-400">
          <p className="text-center">
            {t("Sign In")}
          </p>
        </Link>
